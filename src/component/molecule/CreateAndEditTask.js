...
function CreateAndEditTask({
  ...
  useEffect(() => {
    setTaskName(selectName);
    setTaskPercentage(selectPercentage);
  }, [selectName, selectPercentage]);
  ...
  const saveFunction = () => {
    if (nameActivity == "New Task") {
      ...
      editTask(taskName, taskPercentage);
      onClose();
    }
  };
        ...
        <div>
          <div className={classes.paper}>
            ...
            <div style={{ display: "flex", justifyContent: "flex-end" }}>
              ...
              <Tombol color="primary" text="Save" method={saveFunction} />
            </div>
          </div>
        </div>
      </Fade>
